...
@secreflist
  ...
  @refitem DehydrationTable "Dehydration"
...
#### Patient Actions
@secreflist
  @refitem AcuteRespiratoryDistressSyndromeExacerbationTable "Acute Respiratory Distress Syndrome (ARDS) Exacerbation"
  ...
  @refitem CardiovascularMechanicsModificationTable "Cardiovascular Mechanics Modification"
  ...
  @refitem ChronicObstructivePulmonaryDiseaseExacerbationTable "Chronic Obstructive Pulmonary Disease (COPD) Exacerbation"
  @refitem ConsciousRespirationTable "Conscious Respiration"
  @refitem ConsumeNutrientsTable "Consume Nutrients"
  @refitem DyspneaTable "Dyspnea"
  @refitem ExerciseTable "Exercise"
  @refitem HemorrhageTable "Hemorrhage"
  @refitem HemothoraxTable "Hemothorax"
  ...
  @refitem RespiratoryMechanicsModificationTable "Respiratory Mechanics Modification"
  ...
  @refitem TubeThoracostomyTable "Tube Thoracostomy"
...
@secreflist
  ...
  @refitem MechanicalVentilatorContinuousPositiveAirwayPressureTable "Mechanical Ventilator Continuous Positive Airway Pressure (CPAP) Mode"
  @refitem MechanicalVentilatorPressureControlTable "Mechanical Ventilator Pressure Control (PC) Mode"
  @refitem MechanicalVentilatorVolumeControlTable "Mechanical Ventilator Volume Control (VC) Mode"
@endsecreflist
